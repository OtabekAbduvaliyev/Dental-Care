              ...
              <div className="sm:flex sm:items-start">
                <div className="mt-3 text-center sm:mt-0 sm:text-left w-full">
                  ...
                  <form onSubmit={onSubmit} className="space-y-4">
                    <div>
                      <label htmlFor="schedule-name" className="block text-sm font-medium text-gray-700">{t('schedule.name')}</label>
                      <input
                        type="text"
                        id="schedule-name"
                        required
                    ...
                    <div>
                      <label htmlFor="schedule-phone" className="block text-sm font-medium text-gray-700">{t('schedule.phone')}</label>
