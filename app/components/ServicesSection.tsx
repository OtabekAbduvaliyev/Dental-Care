...
export default function ServicesSection({
  ...
  setShowModal
    ...
    const services = [
        {
          icon: <MdHealthAndSafety size={24} className="text-blue-600 dark:text-blue-400" />,
        ...
        {
          icon: <FaTooth size={24} className="text-blue-600 dark:text-blue-400" />,
        ...
        {
          icon: <MdMedicalServices size={24} className="text-blue-600 dark:text-blue-400" />,
        ...
        {
          icon: <FaUserMd size={24} className="text-blue-600 dark:text-blue-400" />,
        ...
        {
          icon: <FaHeartbeat size={24} className="text-blue-600 dark:text-blue-400" />,
        ...
        {
          icon: <FaSmile size={24} className="text-blue-600 dark:text-blue-400" />,
        ...
        {
          icon: <FaTeeth size={24} className="text-blue-600 dark:text-blue-400" />,
        ...
        {
          icon: <MdCleaningServices size={24} className="text-blue-600 dark:text-blue-400" />,
        ...
        {
          icon: <FaBrain size={24} className="text-blue-600 dark:text-blue-400" />,
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            {displayedServices.map((service, index) => (
              <div
                key={index}
                className={`bg-white dark:bg-gray-800 p-8 rounded-lg transition-all duration-200 
                  ${service.popular 
                    ? 'ring-1 ring-blue-100 dark:ring-blue-500/20 shadow-sm hover:shadow-md' 
                    : 'hover:shadow-sm'
                  }`}
              >
                {/* Service Header */}
                <div className="flex items-start justify-between mb-6">
                  <div>
                    <div className="w-12 h-12 flex items-center justify-center rounded-full bg-blue-50 dark:bg-blue-500/10 text-blue-600 dark:text-blue-400 mb-4">
                      {service.icon}
                    </div>
                  ...
                  {service.popular && (
                    <span className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-blue-50 dark:bg-blue-500/10 text-blue-600 dark:text-blue-400">
                      {t('popular')}
                    </span>
                  )}
                </div>
                ...
                <ul className="space-y-3 mb-8">
                  {service.features.map((feature, i) => (
                    <li key={i} className="flex items-center text-gray-600 dark:text-gray-300">
                      <FaCheckCircle className="w-5 h-5 text-blue-600 dark:text-blue-400 mr-3 flex-shrink-0" />
                      <span>{feature}</span>
                    </li>
                  ))}
                </ul>
          ...
          <div className="mt-12 text-center">
            <button
              ...
              className="inline-flex items-center px-6 py-3 border border-blue-600 dark:border-blue-400 text-blue-600 dark:text-blue-400 rounded-lg font-medium hover:bg-blue-50 dark:hover:bg-blue-500/10 transition-colors"
            >
          ...
          <div className="mt-16 pt-12 border-t border-gray-100 dark:border-gray-800">
            <div className="grid md:grid-cols-3 gap-8 text-center">
              <div>
                ...
                <h4 className="font-semibold text-gray-900 dark:text-white">{t('trust.experts.title')}</h4>
                <p className="mt-2 text-sm text-gray-600 dark:text-gray-300">{t('trust.experts.description')}</p>
              </div>
              <div>
                <div className="flex items-center justify-center mb-3">
                  <FaRegHospital className="w-6 h-6 text-blue-600 dark:text-blue-400" />
                </div>
                <h4 className="font-semibold text-gray-900 dark:text-white">{t('trust.facility.title')}</h4>
                <p className="mt-2 text-sm text-gray-600 dark:text-gray-300">{t('trust.facility.description')}</p>
              </div>
              <div>
                <div className="flex items-center justify-center mb-3">
                  <FaSmile className="w-6 h-6 text-blue-600 dark:text-blue-400" />
                </div>
                <h4 className="font-semibold text-gray-900 dark:text-white">{t('trust.satisfaction.title')}</h4>
                <p className="mt-2 text-sm text-gray-600 dark:text-gray-300">{t('trust.satisfaction.description')}</p>
              </div>
            </div>
          </div>
        </div>
